...
function generatePerson(){
    ...
    var result = "You are a " + age + " year old " + sex + " living in " + country + "." + "You are " + eth + ", and of " + rel + " religion. " + "You live in " + urbanarea + ", with " + elec + " and access to " + drinkingwater + " drinking water and " + sanitation + " sanitation."
